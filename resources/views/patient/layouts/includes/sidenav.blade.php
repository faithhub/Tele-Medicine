<nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    ...
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
          <!-- Collapse -->
          {{-- <button  class="backdrop d-xl-none" data-action="sidenav-unpin" data-target="undefined">Close</button>
          <div></div> --}}
          <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            <!-- Nav items -->
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" href="{{ url('patient/index')}}">
              ...
              <li class="nav-item">
                <a class="nav-link" href="profile.html">
                  <i class="ni ni-single-02 text-yellow"></i>
                  <span class="nav-link-text">Buy Drug</span>
                </a>
              </li> --}}
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ url('patient/password')}}">
