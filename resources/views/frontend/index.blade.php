                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">About Us <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>          
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <p data-animation="fadeInLeft" data-delay="0.1s">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi uquip ex ea commodo consequat is aute irure.</p>
                                <a href="{{ url('about')}}" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">About Us <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>          
